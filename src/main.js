        ...
        if (!isMobile) {
            ...
            if (sidescrollbox) {
                ...
                if (scroller) {
                    ...
                    // OPTIMIZATION: Use centralized Loop.js instead of recursive requestAnimationFrame
                    // This reduces overhead by synchronizing all animations to a single RAF loop
